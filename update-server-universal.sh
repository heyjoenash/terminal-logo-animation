...
echo "🚀 Updating server to support universal installer..."
...
# Test the setup
echo "✅ Universal installer created at /var/www/html/universal"
echo ""
echo "🧪 Testing endpoints:"
echo "  • Main script: curl -s cli.brandtrackers.xyz"
echo "  • Universal: curl -s cli.brandtrackers.xyz/universal"
echo ""
